...
#         CUDA_VISIBLE_DEVICES=0 python3 mixup_grad.py --dataset=cifar10.${seed}@${size}-1 --regularizer l2 --gamma 0.00025 $common_args
...
for seed in 1 2 3 4 5; do
    for size in 1000 2500 5000 25000 50000; do
        ...
        CUDA_VISIBLE_DEVICES=1 python3 mixup_grad.py --dataset=cifar100.${seed}@${size}-1 --regularizer l2 --gamma 0.008 $common_args
